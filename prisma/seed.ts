      ...
      opportunities: [
        {
          ...
          description: 'High-aesthetic culinary showcase featuring signature woodfired pizzas, ambience photography, dish modifiers, and instant QR table standees.',
          confidenceScore: 95,
          estimatedImpact: 'HIGH',
        },
        {
          ...
          description: 'Direct zero-commission customer pickup and delivery orders with instant UPI/Card payment integration. Saves 25-30% on Zomato/Swiggy fees.',
          confidenceScore: 90,
          estimatedImpact: 'HIGH',
        },
        {
