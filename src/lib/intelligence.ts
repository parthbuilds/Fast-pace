...
export const SOFTWARE_MODULES: SoftwareModule[] = [
  ...
  {
    id: 'broker_crm',
    name: 'Broker Lead Distribution & Routing CRM',
    category: 'crm',
    description: 'Automated lead distribution engine routing incoming property buyers to local brokers based on availability.',
    estimatedWeeks: 3,
    basePrice: 85000,
    highlightTag: 'Broker CRM',
    techStack: ['Next.js', 'Supabase', 'Twilio Routing', 'NodeJS'],
    clientMonthlyCost: 2500,
    devSelfCost: 0,
  },
  {
    id: 'property_portal',
    name: 'Interactive Property Search & Video Tour Portal',
    category: 'web',
    description: 'Modern listing search portal with advanced neighborhood maps and embedded HD video walkthroughs.',
    estimatedWeeks: 3,
    basePrice: 75000,
    highlightTag: 'Property Portal',
    techStack: ['Next.js', 'Cloudinary Video', 'Mapbox API', 'PostgreSQL'],
    clientMonthlyCost: 2000,
    devSelfCost: 0,
  },
];
  ...
  'Professional Services': {
    ...
    opportunities: [
      ...
      },
      {
        ...
        description: 'Automated lead distribution engine that routes incoming buyers to local brokers based on availability and track deal history.',
        confidence: 95,
        impact: 'HIGH',
        applicableModules: ['broker_crm'],
      },
      {
        type: 'WEBSITE_REDESIGN',
        title: 'Interactive Property Search & Video Tour Portal',
        description: 'Modern listing search portal with advanced filters, neighborhood maps, and embedded HD video walkthroughs.',
        confidence: 90,
        impact: 'HIGH',
        applicableModules: ['property_portal'],
      },
    ],
  },
  Education: {
